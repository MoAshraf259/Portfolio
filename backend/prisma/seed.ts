...
export async function ensureSchema(prisma: PrismaClient) {
...
const projects: SeedProject[] = [
    {
      ...
      description:
        'Automated Buildx pipelines to ship GPU-accelerated Ollama images with pre-baked LLM models.',
      impact:
    ...
    },
    {
      ...
      description:
        'Designed multi-stage CI/CD for a Flask backend and React frontend with environment-aware deploys.',
      impact:
    ...
    },
    {
      ...
      impact:
        'Implemented load-balanced control planes, ingress routing, and streamlined day-2 operations.',
      type: ProjectType.DEVOPS,
      githubUrl: 'https://github.com/MoAshraf259',
    ...
    },
    {
      ...
      description:
        'Implemented SPI, I2C, and USART drivers with accompanying test applications for STM32F446.',
      impact:
        'Delivered reusable peripheral drivers and documentation for rapid embedded prototyping.',
      type: ProjectType.EMBEDDED,
    ...
    },
    {
      ...
      description:
        'Built a FreeRTOS-based RC car with OTA firmware updates via dual-MCU architecture.',
      impact:
        'Enabled remote firmware delivery using Wi-Fi, UART bootloading, and obstacle-avoidance controls.',
      type: ProjectType.EMBEDDED,
      githubUrl: 'https://github.com/MoAshraf259',
