...
- Observability (Prometheus, Grafana, ELK), SLOs, cost monitoring, savings strategies`,
  ...
  courses: [
    {
      id: 1,
      name: 'Certified Kubernetes Administrator (CKA) Prep Course',
      provider: 'KodeKloud',
    ...
    },
    {
      ...
      provider: 'KodeKloud',
      link: 'https://kodekloud.com/courses/aws-certified-cloud-practitioner/',
      sortOrder: 2,
    },
    {
      id: 3,
      name: 'Docker Certified Associate (DCA) Prep Course',
      provider: 'KodeKloud',
      link: 'https://kodekloud.com/courses/docker-certified-associate-dca-certification-exam-course/',
      sortOrder: 3,
    },
    {
      id: 4,
      name: 'KodeKloud DevOps Bootcamp',
      provider: 'KodeKloud',
      link: 'https://kodekloud.com/learning-paths/devops-bootcamp/',
      sortOrder: 4,
    },
  ],
};
